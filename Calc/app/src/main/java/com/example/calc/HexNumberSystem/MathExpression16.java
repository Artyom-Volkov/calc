...
public class MathExpression16
{
    ...
    public MathExpression16(Context context)
    {
        m_context = context;
    ...
    public long GetAnswer()
    {
        ...
        {
            case ADD: answer = operand1+operand2; str_MathExpression = Long.toHexString(operand1) + "+" + Long.toHexString(operand2)+"="+ Long.toHexString(answer);break;
            case SUBTRACT: answer = operand1-operand2; str_MathExpression = Long.toHexString(operand1) + "-" + Long.toHexString(operand2)+"="+ Long.toHexString(answer);break;
            case MULTIPLY: answer = operand1*operand2; str_MathExpression = Long.toHexString(operand1) + "*" + Long.toHexString(operand2)+"="+ Long.toHexString(answer);break;
            case DIVISION: answer = operand1/operand2; str_MathExpression = Long.toHexString(operand1) + "/" + Long.toHexString(operand2)+"="+ Long.toHexString(answer);break;
            case POW: answer = Math.round ( Math.pow(operand1, operand2)); str_MathExpression = Long.toHexString(operand1) + "^" +"(" +Long.toHexString(operand2)+")="+ Long.toHexString(answer);break;
            case SINGCHANGE: answer = (-1) * operand1; str_MathExpression = Long.toHexString(answer);break;
            case LOG: answer = Math.round ( Math.log10(operand1)); str_MathExpression = "Log(" + Long.toHexString(operand1) + ")=" + Long.toHexString(answer);break;
            case EXP: answer = Math.round ( Math.exp(operand1)); str_MathExpression = "exp(" + Long.toHexString(operand1) + ")=" + Long.toHexString(answer);break;
            case FACTORIAL: answer = GetFactorial(operand1); str_MathExpression = Long.toHexString(operand1) + "!=" + Long.toHexString(answer); break;
            case SIN: answer = Math.round ( Math.sin(operand1)); str_MathExpression = "sin(" + Long.toHexString(operand1) + ")=" + Long.toHexString(answer); break;
            case COS: answer = Math.round ( Math.cos(operand1)); str_MathExpression = "cos(" + Long.toHexString(operand1) + ")=" + Long.toHexString(answer);break;
            case TAN: answer = Math.round ( Math.tan(operand1)); str_MathExpression = "tan(" + Long.toHexString(operand1) + ")=" + Long.toHexString(answer);break;
        }
        m_isSetAnswer = true;
        return answer;
    }
