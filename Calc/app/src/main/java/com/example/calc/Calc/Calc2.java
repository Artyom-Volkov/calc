...
public class Calc2
{
    ...
    private CalcHistory2_8_16 m_calcHistory2;
    ...
    public void Initialize()
    {
        ...
        m_calcHistory2 = new CalcHistory2_8_16(numberSystem);
        m_currentmathExpression = new MathExpression_2_8_16(m_context, numberSystem);
    ...
    public void Input_EQUALS()
    {
        ...
        m_currentmathExpression = new MathExpression_2_8_16(m_context, NumberSystem.BIN);
    }
